...
<body>
    ...
    <table class="table table-hover text-center col-md-10">
        <tr>
            ...
            <th>
                <asp:TextBox class="form-control input-group" ID="txtLoggedInUser" tabindex="0" runat="server" Enabled="False"></asp:TextBox>
            </th>
        </tr>
        <tr>
            <th style="text-align:left" >Date:</th>
            <th><asp:TextBox class="form-control input-group" ID="txtTodaysDate" tabindex="1" runat="server" AutoPostBack="True" Enabled="False"></asp:TextBox></th>
        </tr>     
<%--        <tr>
            <th>Purpose: *
...
<%--    <table>
    ...
    <asp:panel id="Panel2" runat="server" groupingtext="* Initiating Department:">
        ...
        <asp:UpdatePanel ID="UpdatePanel5" runat="server" UpdateMode="Always">
            <ContentTemplate>
            <asp:DropDownList class="form-control col-md-10" tabindex="2"  ID="ddlInitiatingDepartment" runat="server" AutoPostBack="True" onselectedindexchanged="ddlInitiatingDepartment_SelectedIndexChanged"></asp:DropDownList>
                <br />
    ...
    <table class="table table-hover text-center col-md-10">
        ...
        <td>
            <asp:TextBox class="form-control input-group" tabindex="3" ID="txtFromName" runat="server" placeholder="field is required"></asp:TextBox>
        </td>
        </tr>       
       <tr>
        <td style="text-align:left"><asp:Label ID="Label3" runat="server" Text="* From Phone: "></asp:Label></td>
        <td><asp:TextBox class="form-control input-group" tabindex="4" ID="txtFromPhone" runat="server" placeholder="field is required"></asp:TextBox></td>
        </tr>
         <tr>
        <td style="text-align:left"><asp:Label ID="Label10" runat="server" Text="* From Email: "></asp:Label></td>
        <td><asp:TextBox class="form-control input-group" tabindex="5" ID="txtEmailAddress" runat="server" placeholder="field is required"></asp:TextBox></td>
        </tr>
    </table>
    <br>
    ...
    <table class="table table-hover text-center col-md-10">
        <tr>
            ...
            <td><asp:TextBox class="form-control input-group" tabindex="6" ID="txttoCompanyOrName" runat="server" placeholder="field is required" ></asp:TextBox></td>
        </tr>
        <tr>
            <td style="text-align:left"><asp:Label ID="Label6" runat="server" Text="* Attn:"></asp:Label></td>
            <td><asp:TextBox class="form-control input-group" tabindex="7" ID="txtToAttn" runat="server" placeholder="needed on business and international"></asp:TextBox></td>
        </tr>
        <tr>
            <td style="text-align:left"> <asp:Label ID="Label7" runat="server" Text="* Address One:"></asp:Label></td>
            <td><asp:TextBox class="form-control input-group" tabindex="8" ID="txtToAddressOne" runat="server" placeholder="field is required"></asp:TextBox></td>
        </tr>
        <tr>
            <td style="text-align:left"><asp:Label ID="Label11" runat="server" Text="Address Two:"></asp:Label></td>
            <td><asp:TextBox class="form-control" tabindex="9" ID="txtToAddressTwo" runat="server"></asp:TextBox></td>
        </tr>
        <tr>
            <td style="text-align:left"><asp:Label ID="Label2" runat="server" Text="* City:"></asp:Label></td>
            <td><asp:TextBox class="form-control input-group" tabindex="10" ID="txtCity" runat="server" placeholder="field is required" ></asp:TextBox></td>
        </tr>
        <tr>
            ...
            <td>
                <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Always">
                    ...
                    <ContentTemplate>
                        <asp:DropDownList class="form-control" tabindex="11" ID="ddlCountries" runat="server" AutoPostBack="True" onselectedindexchanged="ddlCountries_SelectedIndexChanged"></asp:DropDownList>
                    </ContentTemplate>
                </asp:UpdatePanel>
            </td>
        </tr>
        <tr>
            <td style="text-align:left">
                <asp:Label ID="Label8" runat="server" Text="State or Province:"></asp:Label><br />
            ...
            <td>
                <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Always">
                    ...
                    <ContentTemplate>
                    <asp:DropDownList class="form-control" tabindex="12" ID="ddlStates" runat="server"></asp:DropDownList>
                    </ContentTemplate>
                </asp:UpdatePanel>
            </td>
        </tr>
        <tr>
            ...
            <td><asp:TextBox class="form-control input-group" tabindex="13" ID="txtPostalCode" runat="server"  placeholder="field is required"></asp:TextBox></td>
        </tr>
	    <tr>
            <td style="text-align:left"><asp:Label ID="Label5" runat="server" Text="* Phone:"></asp:Label></td>
            <td style="text-align:left" ><asp:TextBox class="form-control input-group" tabindex="14" ID="txtToPhone" runat="server" placeholder="field is required" ></asp:TextBox></td>
        </tr>
<%--        <tr>
    ...
    <asp:TextBox ID="txtState" runat="server" Visible="False" Text=""></asp:TextBox>
    </asp:panel>
    <asp:panel class="col-md-10" id="Panel5" runat="server" groupingtext="* How many packages to ship: ">
        ...
        <asp:UpdatePanel ID="UpdatePanel6" runat="server" UpdateMode="Always">
            ...
            <ContentTemplate>
                <asp:DropDownList class="form-control col-md-4" tabindex="15" ID="ddlNumberItemsShipped" runat="server" AutoPostBack="True" onselectedindexchanged="ddlNumberItemsShipped_SelectedIndexChanged">
                 ...
                 <div class="row">
                    <div class="col-md-8">
                        <asp:TextBox class="form-control input-group" tabindex="16" ID="txtDescriptionOne" runat="server" Visible="False" placeholder="* package one general description"></asp:TextBox>
                        <asp:TextBox class="form-control input-group" tabindex="18" ID="txtDescriptionTwo" runat="server" Visible="False" placeholder="* package two desccription"></asp:TextBox>
                        <asp:TextBox class="form-control input-group" tabindex="20" ID="txtDescriptionThree" runat="server" Visible="False" placeholder="* package three desccription"></asp:TextBox>
                        <asp:TextBox class="form-control input-group" tabindex="22" ID="txtDescriptionFour" runat="server" Visible="False" placeholder="* package four description"></asp:TextBox>
                        <asp:TextBox class="form-control input-group" tabindex="24" ID="txtDescriptionFive" runat="server" Visible="False" placeholder="* package five description"></asp:TextBox>
                        <asp:TextBox class="form-control input-group" tabindex="26" ID="txtDescriptionSix" runat="server" Visible="False" placeholder="*package six description"></asp:TextBox>
                    </div>
                    <div class="col-md-4">
                        <asp:TextBox class="form-control input-group" tabindex="17" ID="txtQuantityOne" runat="server" Visible="False" placeholder="* package one qty"></asp:TextBox>
                        <asp:TextBox class="form-control input-group" tabindex="19" ID="txtQuantityTwo" runat="server" Visible="False" placeholder="* package two qty"></asp:TextBox>
                        <asp:TextBox class="form-control input-group" tabindex="21" ID="txtQuantityThree" runat="server" Visible="False" placeholder="* package three qty"></asp:TextBox>
                        <asp:TextBox class="form-control input-group" tabindex="23" ID="txtQuantityFour" runat="server" Visible="False" placeholder="* package four qty"></asp:TextBox>
                        <asp:TextBox class="form-control input-group" tabindex="25" ID="txtQuantityFive" runat="server" Visible="False" placeholder="* package five qty"></asp:TextBox>
                        <asp:TextBox class="form-control input-group" tabindex="27" ID="txtQuantitySix" runat="server" Visible="False" placeholder="* package six qty"></asp:TextBox>
                    </div>
                </div>                                                                                                                                                                                                                                           
                </ContentTemplate>
            </asp:UpdatePanel>
        </asp:panel>
        <asp:panel class="col-md-10" style="text-align:left" id="Panel10" runat="server" groupingtext="* Delivered By:">
            <table>
                <thead>
                    <tr>
                        <th>
                    ...
                    <tr>
                        <td>
                            <asp:UpdatePanel ID="UpdatePanel7" runat="server" UpdateMode="Always">
                                ...
                                <ContentTemplate>
                                    <asp:Calendar tabindex="28" ID="calShipByDate" runat="server" AutoPostBack="True" onselectionchanged="calShipByDate_SelectionChanged"></asp:Calendar>
                                </ContentTemplate>
                            </asp:UpdatePanel>
                        </td>
                        <td>
                        ...
                        <td>
                            <asp:UpdatePanel ID="UpdatePanel8" runat="server" UpdateMode="Always">
                                ...
                                <ContentTemplate>
                                    <asp:DropDownList class="form-control col-md-12" tabindex="29" ID="ddlShipByTime" runat="server" AutoPostBack="True" onselectedindexchanged="ddlShipByTime_SelectedIndexChanged" >
...
<%--            <table class="table table-hover" style="text-align:left" >
                    ...
                    <tr>
                        <td>
                            <asp:UpdatePanel ID="UpdatePanel9" runat="server" UpdateMode="Always">
                                ...
                                <ContentTemplate>
                                    <asp:DropDownList class="form-control col-md-4" tabindex="30" ID="ddlUrgency" runat="server" OnSelectedIndexChanged="ddlUrgency_SelectedIndexChanged" AutoPostBack="true">
         ...
         <asp:panel class="col-md-10" id="Panel1" runat="server" groupingtext="Comments">     
             <asp:TextBox class="form-control" tabindex="31" ID="txtComments" runat="server" TextMode="MultiLine"></asp:TextBox>
        </asp:panel>
         <asp:panel class="col-md-10" id="Panel7" runat="server" groupingtext="Bill to 3rd party UPS Account No.">
        <asp:TextBox class="form-control col-md-4" tabindex="32" ID="txtBillTo3rdParty" runat="server"></asp:TextBox>
        </asp:panel>                   
         <asp:panel class="col-md-10" id="Panel14" runat="server" groupingtext="Check to require signature">        
            <asp:CheckBox ID="cbSignatureRequired" tabindex="33" runat="server" Text="Residential Recipient's Signature Required (Additional Charge)"/>
        </asp:panel>
